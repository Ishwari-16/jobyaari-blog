            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p style="color:#d1d5db;">Your trusted platform for career insights and job opportunities.</p>
                    </div>
                    <div class="col-md-6 text-md-end">
                        <p style="color:#d1d5db;" class="mb-0">&copy; {{ date('Y') }} JobYaari. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
